...
@Component({
  selector: 'app-update-model-provider',
  templateUrl: './update-model-provider.component.html',
  styleUrl: './update-model-provider.component.css'
})
export class UpdateModelProviderComponent {
  modelId!:any;
  model!:Model;
